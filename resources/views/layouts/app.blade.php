...
<body class="bg-slate-50 text-gray-800 antialiased min-h-screen relative overflow-x-hidden overflow-y-scroll font-sans">
    ...
    <nav class="floating-nav" x-data="{ mobileMenuOpen: false }">
        <div class="flex items-center justify-between w-full lg:w-auto">
            <div class="flex items-center gap-4 transition-opacity">
                ...
                <span class="font-extrabold text-xl text-gray-800 tracking-tight cursor-default">SIPUS</span>
            </div>
        ...
        <div x-data="navHover()" x-init="initNav()" @mouseleave="resetNav()" class="hidden lg:flex relative items-center gap-1 sm:gap-2 z-10 py-1" x-ref="navContainer">
            ...
            @if(Auth::user()->role === 'admin')
                <a href="{{ route('admin.dashboard') }}" @mouseenter="movePill($event.currentTarget)" @focus="movePill($event.currentTarget)" data-active="{{ request()->routeIs('admin.dashboard') ? 'true' : 'false' }}" class="nav-link relative z-10 text-sm font-bold transition-colors duration-300 px-3 xl:px-4 py-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue-500 rounded-full flex items-center justify-center {{ request()->routeIs('admin.dashboard') ? 'text-brand-blue-700' : 'text-gray-600 hover:text-brand-blue-600' }}">Dashboard</a>
                <a href="{{ route('admin.buku') }}" @mouseenter="movePill($event.currentTarget)" @focus="movePill($event.currentTarget)" data-active="{{ request()->routeIs('admin.buku') ? 'true' : 'false' }}" class="nav-link relative z-10 text-sm font-bold transition-colors duration-300 px-3 xl:px-4 py-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue-500 rounded-full flex items-center justify-center {{ request()->routeIs('admin.buku') ? 'text-brand-blue-700' : 'text-gray-600 hover:text-brand-blue-600' }}">Buku</a>
                <a href="{{ route('admin.anggota') }}" @mouseenter="movePill($event.currentTarget)" @focus="movePill($event.currentTarget)" data-active="{{ request()->routeIs('admin.anggota') ? 'true' : 'false' }}" class="nav-link relative z-10 text-sm font-bold transition-colors duration-300 px-3 xl:px-4 py-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue-500 rounded-full flex items-center justify-center {{ request()->routeIs('admin.anggota') ? 'text-brand-blue-700' : 'text-gray-600 hover:text-brand-blue-600' }}">Anggota</a>
                <a href="{{ route('admin.peminjaman') }}" @mouseenter="movePill($event.currentTarget)" @focus="movePill($event.currentTarget)" data-active="{{ request()->routeIs('admin.peminjaman') ? 'true' : 'false' }}" class="nav-link relative z-10 text-sm font-bold transition-colors duration-300 px-3 xl:px-4 py-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue-500 rounded-full flex items-center justify-center {{ request()->routeIs('admin.peminjaman') ? 'text-brand-blue-700' : 'text-gray-600 hover:text-brand-blue-600' }}">Peminjaman</a>
                <a href="{{ route('admin.pengembalian') }}" @mouseenter="movePill($event.currentTarget)" @focus="movePill($event.currentTarget)" data-active="{{ request()->routeIs('admin.pengembalian') ? 'true' : 'false' }}" class="nav-link relative z-10 text-sm font-bold transition-colors duration-300 px-3 xl:px-4 py-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue-500 rounded-full flex items-center justify-center {{ request()->routeIs('admin.pengembalian') ? 'text-brand-blue-700' : 'text-gray-600 hover:text-brand-blue-600' }}">Pengembalian</a>
                <a href="{{ route('admin.denda') }}" @mouseenter="movePill($event.currentTarget)" @focus="movePill($event.currentTarget)" data-active="{{ request()->routeIs('admin.denda') ? 'true' : 'false' }}" class="nav-link relative z-10 text-sm font-bold transition-colors duration-300 px-3 xl:px-4 py-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue-500 rounded-full flex items-center justify-center {{ request()->routeIs('admin.denda') ? 'text-brand-blue-700' : 'text-gray-600 hover:text-brand-blue-600' }}">Denda</a>
                <a href="{{ route('admin.laporan') }}" @mouseenter="movePill($event.currentTarget)" @focus="movePill($event.currentTarget)" data-active="{{ request()->routeIs('admin.laporan') ? 'true' : 'false' }}" class="nav-link relative z-10 text-sm font-bold transition-colors duration-300 px-3 xl:px-4 py-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue-500 rounded-full flex items-center justify-center {{ request()->routeIs('admin.laporan') ? 'text-brand-blue-700' : 'text-gray-600 hover:text-brand-blue-600' }}">Laporan</a>
            @else
                                    ...
                                    <div class="relative mt-6 flex-1 px-4 sm:px-6 flex flex-col gap-2">
                                        <div x-data="navHover()" x-init="initNav()" @mouseleave="resetNav()" class="relative flex-1 flex flex-col gap-2 pb-4" x-ref="navContainer">
                                            ...
                                            @if(Auth::user()->role === 'admin')
                                                ...
                                                <a href="{{ route('admin.pengembalian') }}" @click="mobileMenuOpen = false" @mouseenter="movePill($event.currentTarget)" @focus="movePill($event.currentTarget)" data-active="{{ request()->routeIs('admin.pengembalian') ? 'true' : 'false' }}" class="nav-link relative z-10 block px-4 py-3 rounded-xl font-bold {{ request()->routeIs('admin.pengembalian') ? 'text-brand-blue-700' : 'text-gray-600 hover:text-brand-blue-600' }}">Pengembalian</a>
    ...
    <main class="{{ auth()->check() ? 'pt-28' : 'pt-10 min-h-screen flex flex-col justify-center' }} pb-6 px-4 max-w-7xl mx-auto">
        @if(session('success'))
