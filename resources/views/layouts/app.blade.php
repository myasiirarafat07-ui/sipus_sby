    ...
    <nav class="floating-nav" x-data="{ mobileMenuOpen: false }">
        ...
        <div x-data="navHover()" x-init="initNav()" @mouseleave="resetNav()" class="hidden lg:flex relative items-center gap-1 sm:gap-2 z-10 py-1" x-ref="navContainer">
            ...
            @else
                ...
                <a href="{{ route('katalog.riwayat') }}" @mouseenter="movePill($event.currentTarget)" @focus="movePill($event.currentTarget)" data-active="{{ request()->routeIs('katalog.riwayat') ? 'true' : 'false' }}" class="nav-link relative z-10 text-sm font-bold transition-colors duration-300 px-5 py-2.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue-500 rounded-full flex items-center justify-center {{ request()->routeIs('katalog.riwayat') ? 'text-brand-blue-700' : 'text-gray-600 hover:text-brand-blue-600' }}">Riwayat</a>
                <a href="{{ route('anggota.profil') }}" @mouseenter="movePill($event.currentTarget)" @focus="movePill($event.currentTarget)" data-active="{{ request()->routeIs('anggota.profil') ? 'true' : 'false' }}" class="nav-link relative z-10 text-sm font-bold transition-colors duration-300 px-5 py-2.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue-500 rounded-full flex items-center justify-center {{ request()->routeIs('anggota.profil') ? 'text-brand-blue-700' : 'text-gray-600 hover:text-brand-blue-600' }}">Profil</a>
            @endif
            @endauth
            @guest
            ...
            <a href="{{ route('register') }}" @mouseenter="movePill($event.currentTarget)" @focus="movePill($event.currentTarget)" data-active="{{ request()->routeIs('register') ? 'true' : 'false' }}" class="nav-link text-sm font-bold text-gray-600 hover:text-brand-blue-600 px-5 py-2.5 rounded-full flex items-center justify-center transition-colors relative z-10">Daftar</a>
            @endauth
        </div>
                                    ...
                                    <div class="relative mt-6 flex-1 px-4 sm:px-6 flex flex-col gap-2">
                                        <div x-data="navHover()" x-init="initNav()" @mouseleave="resetNav()" class="relative flex-1 flex flex-col gap-2 pb-4" x-ref="navContainer">
                                            ...
                                            @else
                                                ...
                                                <a href="{{ route('katalog.riwayat') }}" @click="mobileMenuOpen = false" @mouseenter="movePill($event.currentTarget)" @focus="movePill($event.currentTarget)" data-active="{{ request()->routeIs('katalog.riwayat') ? 'true' : 'false' }}" class="nav-link relative z-10 block px-4 py-3 rounded-xl font-bold {{ request()->routeIs('katalog.riwayat') ? 'text-brand-blue-700' : 'text-gray-600 hover:text-brand-blue-600' }}">Riwayat</a>
                                                <a href="{{ route('anggota.profil') }}" @click="mobileMenuOpen = false" @mouseenter="movePill($event.currentTarget)" @focus="movePill($event.currentTarget)" data-active="{{ request()->routeIs('anggota.profil') ? 'true' : 'false' }}" class="nav-link relative z-10 block px-4 py-3 rounded-xl font-bold {{ request()->routeIs('anggota.profil') ? 'text-brand-blue-700' : 'text-gray-600 hover:text-brand-blue-600' }}">Profil</a>
                                            @endif
                                            ...
                                            @guest
                                                ...
                                                <a href="{{ route('register') }}" @click="mobileMenuOpen = false" @mouseenter="movePill($event.currentTarget)" @focus="movePill($event.currentTarget)" data-active="{{ request()->routeIs('register') ? 'true' : 'false' }}" class="nav-link relative z-10 block px-4 py-3 rounded-xl font-bold {{ request()->routeIs('register') ? 'text-brand-blue-700' : 'text-gray-600 hover:text-brand-blue-600' }}">Daftar</a>
                                            @endguest
                                        </div>
                                    </div>
                                </div>
